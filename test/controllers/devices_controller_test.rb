...
class DevicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device" do
    assert_difference("Device.count") do
      post devices_url, params: { device: { identifier: @device.identifier, name: @device.name } }
    end
  ...
  test "should update device" do
    patch device_url(@device), params: { device: { identifier: @device.identifier, name: @device.name } }
